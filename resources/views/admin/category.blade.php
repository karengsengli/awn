        ...
        $(document).ready(function($) {
            ...
            /*$('#myTable').dataTable({
                ...
                "columnDefs": [{
                  "targets": -1,
                  "data": null,
                  "defaultContent": `<button class="btn btn-info btn-sm btn_edit" data-toggle="modal" data-target="#edit-modal" data-id="{ 'data': 'id' }">Edit</button>
                    <button class="btn btn-danger btn-sm btn_delete" data-toggle="modal" data-target="#delete-modal" >Delete</button>`
                }],
                columns: [
                            { 'data': 'id' },
                            { 'data': 'name' },
