...
@section('content')
 <h1 class="h3 mb-4 text-gray-800">Create Project</h1>
          ...
          <div>
            <form action="/save_project" method="post" enctype="multipart/form-data" id="add_form" >
                @csrf
                <div class="form-group">
                    <label for="project_title" class="form-control-label">Title:</label>
                    <input type="text" id="project_title" name="project_title" class="form-control" placeholder="Enter Project Title">
                </div>
                <div class="form-group">
                    <label for="sub_title" class="form-control-label">Sub Title:</label>
                    <input type="text" name="sub_title" id="sub_title" class="form-control" placeholder="Enter Project Sub Title">
                </div>
                <div class="form-group">
                    <label for="client"  class="form-control-label">Client:</label>
                    <input type="text" name="client" id="client" class="form-control" placeholder="Enter Client">
                </div>
                <div class="form-group">
                    <label for="client_web" class="form-control-label">Client Website:</label>
                    <input type="text" name="client_web" id="client_web" class="form-control" placeholder="Enter Client Website">
                </div>
                <div class="form-group">
                    <label for="completed_date" class="form-control-label">Project Completed Date:</label>
                    <input type="date" id="completed_date" name="completed_date" class="form-control" placeholder="Enter Client Website">
                </div>
                <div class="form-group">
                    <label for="post_body" class="form-control-label">Project Detail:</label>
                    <textarea id="summernote" cols="30" rows="10" id="post_body" name="post_body"></textarea>
                </div>
                <div class="form-group">
